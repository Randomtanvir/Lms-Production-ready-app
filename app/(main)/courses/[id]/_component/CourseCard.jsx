...
export default function CourseSidebar({
  ...
  return (
    <div className="w-full max-w-[424px] bg-white border border-gray-200 rounded-lg shadow-lg p-6 space-y-6 mx-auto">
      ...
      {/* Action Buttons */}
      <button className="w-full bg-[#FF6636] text-white py-4 rounded-lg font-semibold hover:bg-[#e55b30] transition">
        Add To Cart
      </button>
      <button className="w-full bg-[#FFEEE8] text-[#FF6636] py-4 rounded-lg font-semibold hover:bg-[#fcd4c7] transition">
        Buy Now
      </button>
